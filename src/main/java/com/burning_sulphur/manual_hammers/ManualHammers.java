...
public class ManualHammers {
    public static final String MOD_ID = "manual_hammers";
    ...
    public ManualHammers(IEventBus modEventBus, ModContainer modContainer) {
        ...
        /* use this to add it to Evan's menu
